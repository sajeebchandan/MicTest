...
namespace Mic_Test
{
    public class GraphVisualization
    {
        ...
        public void Draw(Graphics graphics, int width, int height)
        {
            ...
            //left channel:
            graphics.DrawLines(new Pen(Color.Black, 1), GetPoints(samplesLeft, pixelsPerSample, width, height).ToArray());
            //right channel:
            graphics.DrawLines(new Pen(Color.Red, 0.5f), GetPoints(samplesRight, pixelsPerSample, width, height).ToArray());
        }
